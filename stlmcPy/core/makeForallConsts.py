...
def getForallConsts(const):
    ...
    # Special case : a =/= b
        ...
        subresult = list()
        subresult.append(Forall(const.curMode, const.propID, Gt(handlingExp, RealVal(0)), const.modePropDict, const.startDict, const.endDict, const.ode))
        subresult.append(Forall(const.curMode, const.propID, Lt(handlingExp, RealVal(0)), const.modePropDict, const.startDict, const.endDict, const.ode))
        ...
        if isinstance(exp, Gt):
            ...
            result.append(Implies(handlingExp.substitution(const.startDict) == RealVal(0),
                             Forall(const.curMode, const.propID, Gt(diffExp, RealVal(0)), const.modePropDict, const.startDict, const.endDict, const.ode)))
            # Case : f(t') = 0 -> dot(f(T)) < 0, forall T in (t, t')
            result.append(Implies(handlingExp.substitution(const.endDict) == RealVal(0),
                             Forall(const.curMode, const.propID, Lt(diffExp, RealVal(0)), const.modePropDict, const.startDict, const.endDict, const.ode)))
        elif isinstance(exp, Ge):
            result.append(Ge(handlingExp.substitution(const.startDict), RealVal(0)))
            result.append(Implies(handlingExp.substitution(const.startDict) == RealVal(0),
                             Forall(const.curMode, const.propID, Ge(diffExp, RealVal(0)), const.modePropDict, const.startDict, const.endDict, const.ode)))
            result.append(Implies(handlingExp.substitution(const.endDict) == RealVal(0),
                             Forall(const.curMode, const.propID, Le(diffExp, RealVal(0)), const.modePropDict, const.startDict, const.endDict, const.ode)))
