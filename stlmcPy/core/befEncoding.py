...
def _(f:Formula, sub:dict, j:Interval, base, genPr, fMap, subFormula):
    #print(str(f))
    #print("befoe until")
    result = And(*[intervalConst(j,f.gtime,f.ltime), _value(f.left,sub,f.gtime,base,genPr,fMap, subFormula), _value(f.right,sub,f.gtime,base,genPr,fMap, subFormula)])
    #print("after until")
...
def _(f:Formula, sub:dict, j:Interval, base, genPr, fMap, subFormula):
    #print(str(f))
    #print("befoe release")
    result = Or(*[Not(intervalConst(j,f.gtime,f.ltime)), _value(f.left,sub,f.gtime,base,genPr,fMap, subFormula), _value(f.right,sub,f.gtime,base,genPr,fMap, subFormula)])
    #print("after release")
#    subFormula[f.left] = _value(f.left,sub,f.gtime,base,genPr,fMap, subFormula)
#    subFormula[f.right] = _value(f.right,sub,f.gtime,base,genPr,fMap, subFormula)
    return result 
