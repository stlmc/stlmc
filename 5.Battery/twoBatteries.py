...
class Battery(Model):
    ...
    def __init__(self):
        ...
        flow = {And(self.mb1 == RealVal(1), self.mb2 == RealVal(1)): {self.d1: (RealVal(0.5) / C) - (K * self.constd1), self.d2: (RealVal(0.5) / C) - (K * self.constd2), self.g1: -RealVal(0.5), self.g2: -RealVal(0.5), self.constd1: RealVal(0), self.constd2: RealVal(0)}, \
               And(self.mb1 == RealVal(1), self.mb2 == RealVal(0)): {self.d1: (RealVal(1) / C) - (K * self.constd1), self.d2: -(K * self.constd2), self.g1: -RealVal(1), self.g2: RealVal(0), self.constd1: RealVal(0), self.constd2: RealVal(0)}, \
               And(self.mb1 == RealVal(0), self.mb2 == RealVal(1)): {self.d1: -(K * self.constd1), self.d2: (RealVal(1) / C) - (K * self.constd2), self.g1: RealVal(0), self.g2: -RealVal(1), self.constd1: RealVal(0), self.constd2: RealVal(0)}, \
               And(self.mb1 == -RealVal(1), self.mb2 == RealVal(1)): {self.d1: RealVal(0), self.d2: (RealVal(1) / C) - (K * self.constd2), self.g1: RealVal(0), self.g2: -RealVal(1), self.constd1: RealVal(0), self.constd2: RealVal(0)}, \
               And(self.mb1 == RealVal(1), self.mb2 == -RealVal(1)): {self.d1: (RealVal(1) / C) - (K * self.constd1), self.d2: RealVal(0), self.g1: -RealVal(1), self.g2: RealVal(0), self.constd1: RealVal(0), self.constd2: RealVal(0)}, \
        ...
        inv = {And(self.mb1 == -RealVal(1), self.mb2 == -RealVal(1)): And(self.mb1Next == -RealVal(1), self.mb2Next == -RealVal(1))}
