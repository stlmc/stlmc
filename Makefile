...
.PHONY: all antlr perm clean test test-smoke test-capabilities test-reachability test-solver-equivalence benchmark
.NOTPARALLEL: test
...
test: test-smoke test-capabilities test-reachability benchmark test-solver-equivalence
