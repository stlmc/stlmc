...
.PHONY: antlr clean all %.result-z3-test %.result-hylaa-test %.result-hylaa-reduction-test %.result-hylaa-unsat-core-test
test: $(linear-z3-test) $(linear-hylaa-test) $(linear-hylaa-reduction-test) $(linear-hylaa-unsat-core-test)
	$(info testing start)
	@ echo $<
