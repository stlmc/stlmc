...
def make_automaton():
    ...
    derivatives = [
            ["-1 * coeff_1 * coeff_2 * x1 / 16", "coeff_1 * coeff_2 * (x1 - x2) / 18", "1"],
            ["-1 * coeff_1 * coeff_2 * x1 / 16", "(0.015 + coeff_1 * coeff_2 * (x1 - x2)) / 18", "1"],
            ["(coeff_1 - coeff_1 * coeff_2 * x1) / 16", "(coeff_1 * coeff_2 * (x1 - x2)) / 18", "1"],
            ["(coeff_1 - coeff_1 * coeff_2 * x1) / 16", "(0.015 + coeff_1 * coeff_2 * (x1 - x2)) / 18", "1"]]
    ...
    transition_list = [[("ft", "x1 >= 5 & x2 <= 4", ["x1", "x2", "gTimer"]),
                        ("tf", "x1 <= 4 & x2 >= 5", ["x1", "x2", "gTimer"]),
                        ("tt", "x1 <= 4 & x2 <= 4", ["x1", "x2", "gTimer"])],
                       [("ff", "x1 >= 5 & x2 >= 5", ["x1", "x2", "gTimer"]),
                        ("tf", "x1 <= 4 & x2 >= 5", ["x1", "x2", "gTimer"]),
                        ("tt", "x1 <= 4 & x2 <= 4", ["x1", "x2", "gTimer"])],
                       [("ff", "x1 >= 5 & x2 >= 5", ["x1", "x2", "gTimer"]),
                        ("ft", "x1 >= 5 & x2 <= 4", ["x1", "x2", "gTimer"]),
                        ("tt", "x1 <= 4 & x2 <= 4", ["x1", "x2", "gTimer"])],
                       [("ff", "x1 >= 5 & x2 >= 5", ["x1", "x2", "gTimer"]),
                        ("ft", "x1 >= 5 & x2 <= 4", ["x1", "x2", "gTimer"]),
                        ("tf", "x1 <= 4 & x2 <= 5", ["x1", "x2", "gTimer"])]
...
def run_hylaa():
    ...
    box = [(4.9, 5.1), (4.9, 5.1), (0, 0), (1.0, 1.0)]
