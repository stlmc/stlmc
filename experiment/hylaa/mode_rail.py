...
def make_automaton():
    ...
    transition_list = [[("mode(5)", "40 <= tx & tx <= 50", ["tx", "bx", "vx", "5", "gTimer"]),
                        ("mode(10)", "10 <= tx & tx <= 30", ["tx", "bx", "vx", "10", "gTimer"]),
                        ("mode(-5)", "-5 <= tx & tx <= 0", ["tx", "bx", "vx", "-5", "gTimer"])],
                       [("mode(10)", "10 <= tx & tx <= 30", ["tx", "bx", "vx", "10", "gTimer"]),
                        ("mode(-5)", "-5 <= tx & tx <= 0", ["tx", "bx", "vx", "-5", "gTimer"]),
                        ("mode(0)", "85 <= bx & tx <= -8", ["100 + tx", "bx", "vx", "0", "gTimer"])],
                       [("mode(5)", "40 <= tx & tx <= 50", ["tx", "bx", "vx", "5", "gTimer"]),
                        ("mode(-5)", "-5 <= tx & tx <= 0", ["tx", "bx", "vx", "-5", "gTimer"]),
                        ("mode(0)", "85 <= bx & tx <= -8", ["100 + tx", "bx", "vx", "0", "gTimer"])],
                       [("mode(5)", "40 <= tx & tx <= 50", ["tx", "bx", "vx", "5", "gTimer"]),
                        ("mode(10)", "10 <= tx & tx <= 30", ["tx", "bx", "vx", "10", "gTimer"]),
...
def run_hylaa():
    ...
    box = [(60, 70), (0, 1), (0, 0.1), (0, 0), (0, 0), (1.0, 1.0)]
